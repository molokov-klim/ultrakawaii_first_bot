...
theme: /
    ...
    state: Stories
        a: Вот твой подарочек! Это таблица с поисковыми запросами от пользователей по категориям товаров, мы с тобой будем делать важное дело - стыковать идею со спросом!
